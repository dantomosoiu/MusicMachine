...
public class GetSongInfo : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) 
    {
        ...
        String album = context.Request.Params["album"];
        String artist = context.Request.Params["artist"];

        try
        {
            String url = "http://ws.audioscrobbler.com/2.0/?method=album.getinfo&api_key=2c56070c796b0b0340385e787089e7a1&limit=1&format=json&album=" + album + "&artist=" + artist;
